...
export const Experience = component$<{ entries: ExperienceEntry[] }>(
  ({ entries }) => {
            ...
            <li class="relative">
              ...
              >
                <ol class="overflow-y-hidden border-l border-border-line">
                  {entries.slice(VISIBLE_COUNT).map(renderEntry)}
                </ol>
              </div>
              <button
                type="button"
